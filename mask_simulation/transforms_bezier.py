...
def get_random_affine_matrix(width=512, height=512, tx=0.25, ty=0.25, angle=np.pi*0.25, scale_min=0.1, scale_max=0.5, aspect_ratio_min=0.5, aspect_ratio_max=2.0, shear_max=0.1):
